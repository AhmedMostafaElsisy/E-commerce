...
import 'logic/customer_order/customer_order_cubit.dart';
import 'logic/customer_order/customer_order_states.dart';
...
class _CustomerOrderScreenState extends State<CustomerOrderScreen> {
  ...
  void initState() {
    ...
    customerOrderCubit = BlocProvider.of<CustomerOrderCubit>(context);
    customerOrderCubit.getCustomerOrders();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: MainAppPage(
          screenContent: BlocConsumer<CustomerOrderCubit, CustomerOrderStates>(
            listener: (orderCtx, orderState) {},
            builder: (orderCtx, orderState) {
              if (orderState is CustomerLoadingStates) {
                return const CommonLoadingWidget();
              } else if (orderState is CustomerFailedStates) {
                return CommonError(
                  errorMassage: orderState.error.errorMassage,
                  withButton: true,
                  onTap: () => customerOrderCubit.getCustomerOrders(),
                );
              } else if (orderCtx.read<CustomerOrderCubit>().orderLst.isEmpty) {
                return EmptyScreen(
                  ...
                  children: [
                    CommonAppBar(
                      ...
                      titleWidget: CommonTitleText(
                        textKey: AppLocalizations.of(context)!.lblCustomerRequests,
                    ...
                    Expanded(
                      child: ListView.separated(
                          ...
                          itemCount:
                          orderCtx.read<CustomerOrderCubit>().orderLst.length),
                    )
                  ],
                );
              }
